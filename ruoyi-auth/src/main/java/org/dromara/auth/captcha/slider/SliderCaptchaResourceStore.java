package org.dromara.auth.captcha.slider;
 ...
 * @Description 负责滑块验证码模板和背景图存储的地方
 */
@Component
public class SliderCaptchaResourceStore extends DefaultResourceStore {

    public SliderCaptchaResourceStore() {
        // 滑块验证码 模板 (系统内置)
        ...
        // 2. 添加自定义背景图片
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/a.jpg", "default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/b.jpg", "default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/c.jpg", "default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/d.jpg", "default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/e.jpg", "default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/g.jpg", "default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/h.jpg", "default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/i.jpg", "default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "captcha/slider/j.jpg", "default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "captcha/slider/48.jpg", "default"));
        addResource(CaptchaTypeConstant.CONCAT, new Resource("classpath", "captcha/slider/48.jpg", "default"));
        addResource(CaptchaTypeConstant.WORD_IMAGE_CLICK, new Resource("classpath", "captcha/slider/c.jpg", "default"));
    }
