...
public class PlusSpringCacheManager implements CacheManager, ResourceLoaderAware, InitializingBean {
     ...
     */
    public PlusSpringCacheManager(RedissonClient redisson) {
     ...
     * @param config   object
     */
    public PlusSpringCacheManager(RedissonClient redisson, Map<String, ? extends CacheConfig> config) {
     ...
     * @param codec    object
     */
    public PlusSpringCacheManager(RedissonClient redisson, Map<String, ? extends CacheConfig> config, Codec codec) {
     ...
     */
    public PlusSpringCacheManager(RedissonClient redisson, String configLocation) {
     ...
     * @param codec          object
     */
    public PlusSpringCacheManager(RedissonClient redisson, String configLocation, Codec codec) {
        this.redisson = redisson;
